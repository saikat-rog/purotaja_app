                        ...
                        children: [
                          ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              var currentProduct = productsController
                                  .getProductById(
                          ...
                          Row(
                            mainAxisAlignment:
                            MainAxisAlignment.spaceEvenly, // Ensures even spacing between the containers
                            children: [
                              // Empty Cart button
                              GestureDetector(
                                onTap: () {
                                ...
                                child: Container(
                                  decoration: BoxDecoration(
                                    ...
                                    border: Border.all(
                                        color: AppTheme.bgGrey), // Border with same color
                                    borderRadius: BorderRadius.circular(
                                        8), // Rounded corners
                                  ),
