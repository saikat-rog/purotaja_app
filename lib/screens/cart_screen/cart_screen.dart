      ...
      body: Obx(() {
        if (cartController.cartItems.isEmpty) {
          return Center(child: Padding(
            ...
            child: Column(
              children: [
                SvgPicture.asset('assets/cart_assets/empty_cart.svg', width: screenWidth*0.6,),
                SizedBox(height: 30,),
          ...
          return SingleChildScrollView(
            child: Center(
              child: Column(
                children: [
                  Padding(
                    padding: EdgeInsets.symmetric(horizontal: screenWidth * 0.06, vertical: 30),
                    child: Container(
                          ...
                          children: [
                            ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                var currentProduct = productsController.getProductById(allCartItems[index]['id']);
                                return Padding(
                                      ...
                                      Container(
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            ...
                                            // Quantity text
                                            Text(
                                              allCartItems[index]['quantity'].toString(),
                                              style: Theme.of(context).textTheme.bodyLarge,
                                            ),
                                            // Increase button
                                            IconButton(
                            ...
                            Row(
                              mainAxisAlignment: MainAxisAlignment.spaceEvenly, // Ensures even spacing between the containers
                              children: [
                                // Empty Cart button
                                GestureDetector(
                                  onTap: () {
                                  ...
                                  child: Container(
                                    decoration: BoxDecoration(
                                      color: AppTheme.bgGrey, // Background color
                                      border: Border.all(color: AppTheme.bgGrey), // Border with same color
